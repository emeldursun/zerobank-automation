...
Feature:Find Transactions in Account Activity
  ...
  Scenario: Search date range
    ...
    Scenario: Search description
      ...
      And  click search
      Then results table should only show descriptions contaning "ONLINE"
      When the user enters description "OFFICE"
      And clicks search
      Then results table should only show descriptions contaning "OFFICE"
      But results table should not show descriptions contaning "OFFICE"
